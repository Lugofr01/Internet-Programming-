...
conn = sqlite3.connect('/home/franklugola/lugofr01/projects/final_project/database.db')
...
@app.route("/admin")
def admin():
    dbsession = sql.connect('/home/franklugola/lugofr01/projects/final_project/database.db')        
...
def info():
    ...
    if request.method == 'POST' :
        ...
        with sql.connect('/home/franklugola/lugofr01/projects/final_project/database.db') as frank:
            conn = frank.cursor()
